...
<head>
  ...
  <link id="favicon" rel="icon" type="image/png" sizes="64x64" href="icon.png">
...
?>
  ...
  <div id="row">
    <div id="content" align="left">
      <h1><img src="icon.png" width="60" height="60" alt=""/><?php echo $title; ?></h1>
      ...
      <p class="center">
        ...
        <a class="download-link" href="<?php echo $playLink; ?>">
          <img src="play-badge.png" width="200" height="59" alt="Get it on Google play" />
        </a>
        <?php } ?>
        <?php if (isset($museumLink)) { ?>
        <a class="download-link" href="<?php echo $museumLink; ?>">
          <img src="museum-badge.png" width="200" height="59" alt="Get it on Google play" />
        </a>
        <?php } ?>
      </p>
    </div>
    <div id="hero">
      <img src="hero.png" width="500" height="655" alt="Currency" />
    </div>
  </div>
  <div id="footer">
