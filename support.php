...
<div class="wosaIntro">
    ...
    <ul style="margin-left:4em;margin-right:4em;margin-top:40px;font-size:1.1em;">
      ...
      <li><b>Mirroring:</b> Museum contents are not hosted on the archive server, but on mirrors around the world to maximize availability.<br><a href="https://appcatalog.webosarchive.org/" target="_top">Contact the Curator</a> if you can help!<br>&nbsp;</li>
      <li><b>Coding:</b> If you can write code for the web, you can write code for webOS!<br>Check out the <a href="https://sdk.webosarchive.org/" target="_top">SDK</a>, and reach out to the <a href="http://www.webosarchive.org/docs/community">Community</a> about how you can pitch in!<br>&nbsp;</a></li>
      <li><b>Documenting and Archival:</b> Lots of content has been preserved by the Wayback Machine, but much of it needs updating, or re-working for modern times. <a href="https://github.com/webosarchive/webos-docs">Pull Requests</a> are welcome!<br>&nbsp;</li>
    </ul>
    <br>&nbsp;
    <br>&nbsp;
</div>
